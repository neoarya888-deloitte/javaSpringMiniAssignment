package com.miniAssignment.miniAssignment.services;

import com.miniAssignment.miniAssignment.models.Movie;
import com.miniAssignment.miniAssignment.repositories.RepositoryMovie;
...
@Service
public class ServicesMovie {
    @Autowired
    private Movie movie;

    @Autowired
    private RepositoryMovie movieRepository;
    public List<Movie> readCsv() {
        ...
        try {
            // create a reader
            Reader reader = Files.newBufferedReader(Paths.get("C://Users//neoarya//Desktop//muleSchool-Java//javaSpringBoot//movies.csv"));
    ...
    public List<String> getdirector(String director, int startYear, int endYear) {
        String accessKey = "12345keypass";
        String secretKey = "12345accesskey";
...
//                   System.out.println(year);
    ...
    public List<String> getEnglishTitlesWithUserReviewsGreaterThan(int userReviewFilter) {
        String accessKey = "12345accesskey";
        String secretKey = "12345keypass";
        String region = "mumbai";
        List<String> titles = new ArrayList<>();
